...
//  Seepet
//
//  Created by jin lei on 13-11-22.
//
//

#import "BTELoadingView.h"

@implementation BTELoadingView

+ (id)loadingViewInView:(UIView *)aSuperview {
    BTELoadingView *loadingView =
    [[BTELoadingView alloc] initWithFrame:[aSuperview bounds]];
    if (!loadingView) {
        return nil;
    }
...
- (void)drawRect:(CGRect)rect {
    ...
    CGPathRef roundRectPath = getNewPathWithRoundRect(rect, ROUND_RECT_CORNER_RADIUS);
...
CGPathRef getNewPathWithRoundRect(CGRect rect, CGFloat cornerRadius) {
    //
