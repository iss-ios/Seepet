...
- (void)viewDidLoad
{
    ...
    NSArray *tabArray = [[NSArray alloc] initWithObjects:@"我的收藏", nil];
    ...
    _TableView.frame = CGRectMake(_TableView.frame.origin.x, _TableView.frame.origin.y, _TableView.frame.size.width, Screen_Height-_TableView.frame.origin.y);
...
-(void)loadPosts
{
    ...
    [self doService:@"200002" setCmd:@"2" setConditions:conditions setHttpInfo:^(BTEHttpResult *result) {
