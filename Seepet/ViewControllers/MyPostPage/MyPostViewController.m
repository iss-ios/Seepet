...
- (void)viewDidLoad
{
    ...
    NSArray *tabArray = [[NSArray alloc] initWithObjects:@"已审",@"审中",@"未审", nil];
...
-(void)refreshHeaderView
{
    ...
    [self loadPostsWithType:postType];
}
...
-(void)loadPostsWithType:(NSInteger)type
{
...
//5为已审，8为审中，7为未审
    ...
    [self doService:@"200002" setCmd:cmdCode setConditions:conditions setHttpInfo:^(BTEHttpResult *result) {
