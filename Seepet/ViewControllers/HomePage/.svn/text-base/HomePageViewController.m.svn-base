...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    [menu._TableView selectRowAtIndexPath:inde animated:NO scrollPosition:UITableViewScrollPositionTop];
...
{
    if (((BTEUserBean *)[[self getAms] getUserInfo]) != nil) {
        ...
        [[UIApplication sharedApplication].keyWindow makeToast:@"请先登陆！" duration:2.0 position:@"center"];
