...
-(id)initWithFrame:(CGRect)frame leftImage:(UIImage *)lImage rightImage:(UIImage *)rImage andSelecteIndex:(NSInteger)index
{
    self = [super initWithFrame:frame];
    if (self) {
        
        leftCheckButton = [[CheckButton alloc] initWithFrame:CGRectMake(0, 0, 90, 35) andImage:lImage];
        leftCheckButton.tag = 0;
        rightCheckButton = [[CheckButton alloc] initWithFrame:CGRectMake(105, 0, 90, 35) andImage:rImage];
